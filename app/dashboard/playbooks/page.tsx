...
const playbooks = [
  {
    ...
    description: 'Automated response to ransomware detection and encryption attempts',
    stages: ['Isolation', 'Detection', 'Analysis', 'Recovery', 'Analyst Approval'],
    successRate: 94,
    triggers: ['Malware Detection', 'Suspicious File Activity'],
  },
  {
    id: 'pb-insider',
    name: 'Insider Threat Response',
    description: 'Detect and respond to unauthorized data access and exfiltration',
    stages: ['Monitoring', 'Detection', 'Isolation', 'Investigation', 'Management Approval'],
    successRate: 87,
    triggers: ['Abnormal Data Access', 'After-Hours Activity'],
  },
  {
    id: 'pb-phishing',
    name: 'Phishing Response',
    description: 'Automated detection and quarantine of phishing emails',
    stages: ['Email Detection', 'Quarantine', 'User Notification', 'Hunt', 'Threat Intel'],
    successRate: 91,
    triggers: ['Malicious Email', 'Suspicious Link'],
  },
  {
    id: 'pb-malware',
    name: 'Malware Containment',
    description: 'Immediate isolation and containment of malware-infected systems',
    stages: ['Detection', 'Isolation', 'Termination', 'Quarantine', 'Scan'],
    successRate: 96,
    triggers: ['Malware Signature Match', 'Behavioral Detection'],
  },
];
