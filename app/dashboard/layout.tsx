...
const navItems = [
  ...
  { href: '/dashboard/alerts', label: 'Security Alerts', icon: AlertTriangle },
  ...
  { href: '/dashboard/rules', label: 'EDR Rules', icon: BookOpen },
  { href: '/dashboard/logs', label: 'Host logs', icon: GitBranch },
...
export default function DashboardLayout({
  ...
  const navItemPermissions: Record<string, string> = {
    ...
    '/dashboard/rules': 'manage_playbooks',
