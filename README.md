...
- **Behavior-Based EDR Rule Engine & Incident Correlation**: Modular stateful rule engine that evaluates ICMP Floods, Port Scans, Brute Force Authentication, DNS Beaconing, Reverse Shells, and Data Exfiltration. `IncidentCorrelationEngine` clusters multi-stage alerts into unified `CorrelatedIncident` (`ICMP01`, `SCAN01`, `AUTH01`, `EXFIL01`) timelines mapped to MITRE ATT&CK tactics with confidence and risk scores.
